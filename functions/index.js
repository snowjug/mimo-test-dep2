...
// google-auth-library is loaded only when Google authentication is needed
// pdf-lib is loaded only when PDF processing is needed
...
const googleClient = new OAuth2Client(
  process.env.GOOGLE_CLIENT_ID || "144514765704-a3nm5kgbtehioia9eki37s3t8doasfi1.apps.googleusercontent.com"
);
...
// ================= GMAIL: PRINT FAILURE NOTIFICATION =================
