    ...
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
        <MetricCard
          ...
          subtext="Cumulative across period"
        ...
        <MetricCard
          ...
          subtext="Billed customer requests"
        ...
        <MetricCard
          ...
          subtext="Actual physical output"
        ...
        <MetricCard
          ...
          subtext="Fleet SLA Benchmark: 98%"
      ...
      <div className="p-5 sm:p-6 rounded-2xl bg-[#10223A] border border-[#1D3A59] shadow-lg">
        <div className="flex items-center justify-between pb-4 border-b border-[#1D3A59] mb-4">
          <div>
            <h3 className="text-base font-bold text-[#F5F7FA]">Revenue vs Page Volume Trends</h3>
            <p className="text-xs text-[#8EA6BF] mt-0.5">
              Daily revenue generation plotted against hardware page rasterization volume.
            </p>
          </div>
        ...
        <RevenueVolumeAreaChart data={data.revenueTrends} height={320} />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-6">
        ...
        <div className="p-5 sm:p-6 rounded-2xl bg-[#10223A] border border-[#1D3A59] shadow-lg flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between pb-3.5 border-b border-[#1D3A59]">
              <div>
                <h3 className="text-sm font-bold text-[#F5F7FA]">Kiosk Output Comparison</h3>
        ...
        <div className="p-5 sm:p-6 rounded-2xl bg-[#10223A] border border-[#1D3A59] shadow-lg flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between pb-3.5 border-b border-[#1D3A59]">
              <div>
                <h3 className="text-sm font-bold text-[#F5F7FA]">Document Categories</h3>
