    ...
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
        <MetricCard
          ...
          subtext="All transactions logged"
        ...
        <MetricCard
          ...
          subtext="Completed kiosk sessions"
        ...
        <MetricCard
          ...
          subtext="~13.8 pages per session"
          icon={<IndianRupee size={20} />}
          trendText="Nominal"
          trendPositive={true}
        />
          ...
          >
            <div className="flex items-center justify-between pb-3 border-b border-[#1D3A59]">
              <div className="flex items-center gap-2">
                {getMethodIcon(pm.method as any)}
                  ...
                  {filteredTransactions.map((tx) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-5 text-center">
                        <Badge
                          variant={tx.status === 'completed' ? 'completed' : 'failed'}
                          size="sm"
                        >
