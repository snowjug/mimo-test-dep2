    ...
    <header className="h-18 bg-[#0A1728] border-b border-[#1D3A59] px-4 sm:px-6 lg:px-8 flex items-center justify-between sticky top-0 z-20 font-sans shadow-lg">
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        ...
        <button
          ...
          onClick={toggleTheme}
          title="Toggle Theme"
          className="min-h-[40px] min-w-[40px] flex items-center justify-center p-2 rounded-xl bg-[#07111F] border border-[#1D3A59] text-amber-400 hover:text-amber-300 hover:border-[#20D3A2]/50 transition-all cursor-pointer shadow-xs"
        >
