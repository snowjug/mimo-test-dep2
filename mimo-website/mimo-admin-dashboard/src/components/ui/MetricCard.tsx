...
export const MetricCard: React.FC<MetricCardProps> = ({
  ...
  return (
    <div
      className={`bg-[#10223A] rounded-2xl border border-[#1D3A59] p-6 sm:p-7 shadow-xl hover:border-[#20D3A2]/40 transition-all flex flex-col justify-between ${className}`}
    >
